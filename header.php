...
<?php /*?>	<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.svg" alt="" style="position:absolute;width:100px;height:100px;top:50%;left:50%;transform:translate(-50%,-50%);"><?php */?>

<!-- Generator: Adobe Illustrator 24.0.2, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
<svg version="1.1" id="logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;position:absolute;width:100px;height:100px;top:50%;left:50%;transform:translate(-50%,-50%);" xml:space="preserve">
<style type="text/css">
...
<g id="strs">
	<g class="str-1" style="transform:translate(0, 15%) scale3d(1.50, 1.50, 1.00);opacity:0;">
	...
	<g class="str-2" style="transform:translate(0, 15%) scale3d(1.50, 1.50, 1.00);opacity:0;">
	...
	<g class="str-3" style="transform:translate(0, 15%) scale3d(1.50, 1.50, 1.00);opacity:0;">
	...
	<g class="str-4" style="transform:translate(0, 15%) scale3d(1.50, 1.50, 1.00);opacity:0;">
	...
	<g class="str-5" style="transform:translate(0, 15%) scale3d(1.50, 1.50, 1.00);opacity:0;">
	...
	<g class="str-6" style="transform:translate(0, 15%) scale3d(1.50, 1.50, 1.00);opacity:0;">
