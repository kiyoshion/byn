const imagesLoaded = require('./imagesloaded.pkgd.min');

export default function initSmoothAnimation() {
    const MathUtils = {
    ...
    window.addEventListener('resize', function () {
        if (lastInnerWidth != this.window.innerWidth) {
            calcWinsize();
        }
    });
    ...
    let docScroll;
    // let notResize = false;
    // let jsSmoothScroll = document.querySelector('.js-smooth-scroll');
    // jsSmoothScroll.onclick = !notResize;
